...
data class PokerTable(
        ...
        internal val winnerPlayerNumbers: VavrList<PlayerNumber> = VavrList.empty(),
        ...
        internal val allPlayers: VavrList<Player> = VavrList.empty(),
        internal val cardsOnTable: VavrList<Card> = VavrList.empty(),
