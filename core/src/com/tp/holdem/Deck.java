...
public class Deck {
  	...
  	public Deck(){
    		for(int i=0; i<=12; i++)
    		{
      			cards.add(new Card(honours[i], suits[0], i+2));
      			cards.add(new Card(honours[i], suits[1], i+2));
      			cards.add(new Card(honours[i], suits[2], i+2));
      			cards.add(new Card(honours[i], suits[3], i+2));
    		}
  	}
